<div class="flex flex-col">
    <table class="text-xs text-black capitalize text-center dark:text-black mb-8">
        <thead>
            <tr>
                <th class="border border-gray-600 font-bold bg-gray-100">Primer Apellido</th>
                </th>
                <th class="border border-gray-600 font-bold bg-gray-100">Número de la cuenta de banco</th>
                <th class="border border-gray-600 font-bold bg-gray-100">Dirección</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border border-gray-600 bg-gray-100">{{$dato->bankAccount}}</td>
                <td class="border border-gray-600 bg-gray-100">{{$dato->address}}</td>
                ...
                <td
                    ...
                    <a class="flex items-center justify-center"
                        href="{{route('LayoutsPrincipal.Clientes.edit',$dato->id)}}">
