            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex">
                        ...
                        text-slate-500 text-xs capitalize flex justify-center items-center w-14
                        ...
                        <h1 class="text-2xl font-bold pl-24">
                            Editar información del cliente: {{$cliente->lastname}}
                        </h1>
                    </div>
                    <div class="flex justify-center p-5">
                        <livewire:clientes.editar-cliente :cliente="$cliente"/>
                    </div>
                </div>
            </div>
        </div>
